...
- Added the exact Gait v1.4.0 activation fixture pack from PR #170 commit `4509fa7`: six byte-pinned development-signed goldens, public fixture key, and three manifest rejection dispositions.
