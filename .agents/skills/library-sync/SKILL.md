...
Then read `factory/skills/library-sync/SKILL.md` and follow that Factory skill exactly, using the active `axym` repo profile unless the user provides another explicit profile.
