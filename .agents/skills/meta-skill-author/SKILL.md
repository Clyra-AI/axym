...
Then read `factory/skills/meta-skill-author/SKILL.md` and follow that Factory skill exactly, using the active `axym` repo profile unless the user provides another explicit profile.
