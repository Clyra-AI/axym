...
Then read `factory/skills/repo-audit/SKILL.md` and follow that Factory skill exactly, using the active `axym` repo profile unless the user provides another explicit profile.
