...
is released as Gait v1.4.0 at tag commit `a44fdcf` and is traceable to the PR
#170 fixture-generation commit `4509fa7`. The released tag contains the same
manifest, key, and golden bytes. Its six activated goldens and three rejection
dispositions are committed byte-for-byte.
